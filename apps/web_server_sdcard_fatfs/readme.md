...
## Development kits
The following table provides links to the documentation to the **Web Net Server** Application on SAM E70/V71 family on both baremetal( non-RTOS) and FreeRTOS.
