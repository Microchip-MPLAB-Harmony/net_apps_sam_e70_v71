...
The TCP Client configuration demonstrates creating a network client using AT24MAC with the MPLAB Harmony TCP API to make a TCP/IP connection to a web server.<br />The Atmel AT24MAC402 and AT24MAC602 provides 2048 bits of Serial Electrically-Erasable Programmable Read-Only Memory \(EEPROM\) organized as 256 words of eight bits each and is accessed via an I2C-compatible \(2-wire\) serial interface.
...
-   **TCP/IP Root Layer Project Graph**
    ...
    ![tcpip_same70_v71_project](GUID-A45ECF2C-3CA1-42E9-8097-AD98DB9A2F78-low.png)
...
3.  Execution :
    ...
    1.  After the successful broad bring up, the console output becomes
        ...
        ![tcpip_tcp_client_project](GUID-9304888B-767B-42C8-9F67-2261BBA85FCB-low.png)
    ...
    5.  For TCP Client test, input the following command from the serial port: **openurl < url \>** - The < url \> argument must be a fully formed URL; for instance, http://www.microchip.com/.
        ...
        ![tcpip_tcp_client_project](GUID-6649DFA6-FBD6-4B3C-B39C-CCF0C9C2B658-low.png)
